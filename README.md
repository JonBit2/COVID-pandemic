...
Two kinds of test are available for COVID-19: [viral tests](https://www.cdc.gov/coronavirus/2019-ncov/testing/diagnostic-testing.html) and [anitbody tests](https://www.cdc.gov/coronavirus/2019-ncov/testing/serology-overview.html).

* A viral test tells you if you have a current infection.

* An anitbody test tells you if you had a previous infection.

And anitbody test may not be able to show if you have a current infection, because it can take 1-3 weeks after infection to make anitbodies . We do not know yet if having anitbodies to the virus can protect someone from getting infected with the virus again, or how long that protection might last.
...
* CDC has [guidance](https://www.cdc.gov/coronavirus/2019-nCoV/hcp/clinical-criteria.html) for who should be tested, but decisions about testing are made by state[state](https://www.cdc.gov/publichealthgateway/healthdirectories/healthdepartments.html) and [local](https://www.naccho.org/membership/lhd-directory) health departments or healthcare providers.
...
For information on evaulating and testing see [recommendations for reporting, testing, and specimen collection](https://www.cdc.gov/coronavirus/2019-nCoV/hcp/clinical-criteria.html).

**For public health professionals** 

For information on anitbody surveillance, see [objectives and types of surveys](https://www.cdc.gov/coronavirus/2019-ncov/covid-data/serology-surveillance/index.html).

**For Laboratorians**

For information on CDC viral and anitbody testing, see information on [CDC lab tests](https://www.cdc.gov/coronavirus/2019-nCoV/lab/index.html).

### More information 

[HHS Commuunity Based Viral Testing Sites for COVID-19](https://www.hhs.gov/coronavirus/community-based-testing-sites/index.html)
...
The U.S. Food and Drug Administration (FDA) has authorized two viral tests that let you collect either a [nasal swabe](https://www.fda.gov/news-events/press-announcements/coronavirus-covid-19-update-fda-authorizes-first-test-patient-home-sample-collection) or a [saliva sample](https://www.fda.gov/news-events/press-announcements/coronavirus-covid-19-update-fda-authorizes-first-diagnostic-test-using-home-collection-saliva) at home. However, you will still need to send your sample to a laboratory for analysis.
...
### For healthcare professionals
For informationon evaluation and testing, see [recommendations for reporting, testing, and specimen collection](https://www.cdc.gov/coronavirus/2019-nCoV/hcp/clinical-criteria.html)
...
[U.S. Food and Drug Administration FAQs on Viral Testing for SARS-CoV-2external icon](https://www.fda.gov/medical-devices/emergency-situations-medical-devices/faqs-testing-sars-cov-2)
...
Learn more about [using antibody tests](https://www.cdc.gov/coronavirus/2019-ncov/lab/resources/antibody-tests.html) to look for past infection.
...
## CDC's work in anitbody testing
...
* The virus is thought to [spread mainly from person-to-person.](http://https://www.cdc.gov/coronavirus/2019-ncov/prevent-getting-sick/how-covid-spreads.html)
...
* **Then, use a household disinfectant.** Most common [EPA-registered household disinfectants](https://www.epa.gov/pesticide-registration/list-n-disinfectants-use-against-sars-cov-2-covid-19) will work.
...
![Alt Text](https://www.cdc.gov/coronavirus/2019-ncov/images/COVIDweb_avoidCloseContact_masks_rect-01.png)
...
Helpline](https://www.samhsa.gov/disaster-preparedness), call 1-800-985-5990, or text TalkWithUs to 66746
